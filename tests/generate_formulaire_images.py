...
python tests/generate_formulaire_images.py --ids p01 (tu veux ajouter --versions v1 (ou v2) pour lancer une version specifique)
"""
import sys
import os
import json
...
from pipeline.versions.v1_llm_prim.pipeline_v1_1_1 import (object_rec as object_rec_v111,place_scene,phi3_cache,)
from pipeline.versions.v1_llm_prim.object_recognition.object_rec_v1_1_embedding import (object_rec as object_rec_embed,)
...
def main():
    ...
    parser.add_argument("--versions", nargs="+", choices=["v1", "v2"], default=["v1", "v2"],
                        help="Versions a executer (defaut: v1 v2)")
    ...
    version_fns = {"v1": run_v111, "v2": run_v2}
